    ...
    <div class="card-users">
        ...
        <div class="filter" style="max-width:400px;display: inline-block;">
            ...
            <form id="filter-appoiment" action="" method="POST">
                <div>
                    <span>Psicólogo: </span>
                    <?php echo $appoiment_controller->show_psychologist_to_select($required = false)?>
                </div>
                <div>
                    <span>Paciente: </span>
                    <?php echo $appoiment_controller->show_patient_to_select($required = false)?>
                </div>
                <div>
                    <span>Período: </span>
        ...
        <?php
            if (isset($_POST['filter'])) {
                $appoiment_controller->get_filtered_appoiments($_SESSION['profile'][1]['access_to_appoiment']['view'], $_POST);
            }else{
                $appoiment_controller->get_all_appoiments($_SESSION['profile'][1]['access_to_appoiment']['view']);
            }
        ?>
        </ul>
    </div>
